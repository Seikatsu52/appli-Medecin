...
function updateHeroState(isAuthenticated) {
    ...
    if (isAuthenticated && currentPatient) {
        ...
        heroLead.textContent =
            'Votre espace patient est pret: consultez la carte, reservez un creneau et suivez vos rendez-vous a venir.';
        return;
    }
    ...
    heroLead.textContent =
        'Recherchez un praticien de proximite, connectez-vous puis reservez un creneau de 20 minutes.';
}
